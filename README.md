![](https://i.imgur.com/tFVTGfJ.png)
---
Putting private keys directly into websites is not safe or secure. Yet this is currently how nearly every Hive-based site or service currently works. On top of that, most Hive users likely use their master password which is even worse

The Vessel desktop wallet software is a secure alternative, but it is too difficult to use for the majority of Hive users and does not easily interact with websites and services for the Hive Blockchain - which is Hive's primary use case.
...
Hive Keychain aims to bring the security and ease-of-use of Metamask to the Hive blockchain platform and it's dApps!

## Installation
You can download and install the latest published version of the extension for the following browsers:

- Google Chrome (or Brave): Currently under Review and available soon. (You can clone this Repository and Install the Extension manually.)
...
- Send a transfer
- Send Hive Engine tokens (Currently not supported - to be updated soon.)
- Send Delegations
- Power up/down
- Vote for witnesses
...
Where "key_type" can be "Posting" or "Active" and "display_name" is a user-friendly name of the operation to be shown to the user so they know what operation is being broadcast (ex. "Splinterlands Card Transfer").
