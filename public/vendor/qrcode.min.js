        ...
        a = (function() {
          function i(t, r) {
            ...
            var u = t,
              ...
              i = function() {
                for (
                  var t = w.getPatternPosition(u), r = 0;
                  r < t.length;
                  r += 1
                )
              ...
              v = function(t, r) {
                for (
                  var e = (f << 3) | r, n = w.getBCHTypeInfo(e), o = 0;
                  o < 15;
                  o += 1
                ) {
                  var i = !t && 1 == ((n >> o) & 1);
              ...
              p = function(t, r, e) {
                for (
                  var n = B.getRSBlocks(t, r), o = C(), i = 0;
                  i < e.length;
                  i += 1
                ) {
                  var a = e[i];
                ...
                return (function(t, r) {
                  for (
                    ...
                    for (
                      a[u] = new Array(s.getLength() - 1), l = 0;
                      l < a[u].length;
                      l += 1
                    ) {
                  ...
                  for (l = 0; l < n; l += 1)
                    for (u = 0; u < r.length; u += 1)
                      l < i[u].length && ((d[p] = i[u][l]), (p += 1));
                  for (l = 0; l < o; l += 1)
                    for (u = 0; u < r.length; u += 1)
                      l < a[u].length && ((d[p] = a[u][l]), (p += 1));
                  return d;
                })(o, n);
              };
            return (
              ...
              (h.make = function() {
                if (u < 1) {
                  for (var t = 1; t < 40; t++) {
                    for (
                      var r = B.getRSBlocks(t, f), e = C(), n = 0;
                      n < c.length;
                      n++
                    ) {
                      var o = c[n];
              ...
              (h.createSvgTag = function(t, r) {
                ...
                for (
                  ...
                  for (i = o * t + r, n = 0; n < h.getModuleCount(); n += 1)
                      ...
                      for (
                        ...
                        (i = "█"),
                          u <= e &&
                            ...
                            u <= r &&
                            r < f &&
                            h.isDark(n, Math.floor((e - u) / 1)) &&
                            (i = " "),
                          u <= e &&
                          e < f &&
                          u <= r + 1 &&
                          r + 1 < f &&
                          h.isDark(o, Math.floor((e - u) / 1))
                            ? (i += " ")
                            : (i += "█"),
                          (s += t < 1 && f <= r + 1 ? l[i] : c[i]);
                      s += "\n";
          ...
          : "image" === e &&
            (function(t, r) {
              var e = r.size,
                ...
                i = 0.01 * r.mSize,
                a = (i * n) / o,
                u = (1 - a) * r.mPosX * 0.01 * e,
                f = (1 - i) * r.mPosY * 0.01 * e,
                c = a * e,
                l = i * e;
