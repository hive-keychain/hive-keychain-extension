...
const escapeHtmlParams = (params?: unknown | unknown[]) => {
...
const getSafeI18nHtml = (message: string, params?: unknown | unknown[]) =>
  sanitizeHtml(chrome.i18n.getMessage(message, escapeHtmlParams(params)), {
