...
const FEES_URL = 'https://hive-keychain.com/#/fees';
const LEGAL_LINKS_I18N_KEY = 'accept_terms_and_condition';
...
const getI18nHtml = (
  ...
  if (message === LEGAL_LINKS_I18N_KEY) {
    return getLegalLinksHtml(html);
  }
