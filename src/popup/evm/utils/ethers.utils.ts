...
const getGasAmount = async (
  ...
  const test = new Wallet(wallet.signingKey, provider);
  ...
  console.log(erc20, recipient);
  const estimation = await erc20
    .getFunction('transfer')
    .estimateGas(recipient, amount * 1000000); // TODO change

  const estimation2 = await erc20.transfer.estimateGas(
    recipient,
    amount * 1000000,
  );

  console.log(estimation, estimation2);
  return estimation;
};
