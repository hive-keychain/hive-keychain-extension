...
$("#send_cp").click(function() {
  steem_keychain.requestCreateProposal($("#cp_username").val(), $("#cp_receiver").val(), $("#cp_subject").val(), $("#cp_permlink").val(), $("#cp_daily_pay").val(), $("#cp_start").val(), $("#cp_end").val(), $("#cp_extensions").val(), function(response) {
